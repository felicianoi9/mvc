...
class Users extends Model{
	...
	public function findUsersInGroup($id){
		...
		$sql = $this->db->prepare("SELECT * FROM users WHERE id_group=:id_group ");
	...
	public function add($name, $email, $pass, $group, $id_company){
		...
		if($row['c']=='0'){
			$sql = $this->db->prepare("INSERT INTO users SET name=:name , email=:email , password=:password , id_group=:id_group , id_company=:id_company ");
